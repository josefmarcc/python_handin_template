...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='A program that writes content to a new file')
    parser.add_argument('pathToCsv', help='The path to the csv file')
    parser.add_argument('-d', '--file file_name', help='The name of the file to overwrite')
